...
p <- ggplot(mds_data, aes(x = D1, y = D2)) +
  ...
  labs(
    title = "Structured Group Simulation Results - Nuclear Power (No Summary)\nMultidimensional Scaling of Cosine Similarities",
    x = "Dimension 1",
    y = "Dimension 2"
  ) +
...
# ---- Save the figure -----------------------------------------------------------
ggsave("mds_nuclear3_ind.png", plot = p, width = 10, height = 9, dpi = 300)
ggsave("mds_nuclear3_ind.pdf", plot = p, width = 10, height = 9)

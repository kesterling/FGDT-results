...
p <- ggplot(mds_data, aes(x = D1, y = D2)) +
  ...
  labs(
    title = "Structured Group Simulation Results - Nuclear Power (3 Options)\nMultidimensional Scaling of Cosine Similarities",
    x = "Dimension 1",
    y = "Dimension 2"
  ) +
...
# ---- Save the figure -----------------------------------------------------------
ggsave("mds_nuclear3.png", plot = p, width = 10, height = 9, dpi = 300)
ggsave("mds_nuclear3.pdf", plot = p, width = 10, height = 9)

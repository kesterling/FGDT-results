...
# This uses the replication data from the most recent experiments (July-August 2026).
...
dirs<-c("trial_id_7320131895","trial_id_4482425013","trial_id_3787048560")


# use the following code if four standpoint options (see below if you have 3 standpoint options)

# trial id 7320131895 is 600 participant, 4 option on nuclear power
...
# trial id 4482425013 is 60 participant
...
# trial id 3787048560 is 6 participant
...
dirs<-c("trial_id_4596857133","trial_id_3661427424","trial_id_8074001077")
...
setwd(project_dir)
sink("results_replication.txt", append=TRUE)
...
# 60 simple randomization: 2004377390
# 6 stratified design: 7630353616
# 6 simple randomization: 9189104193

dirs<-c("trial_id_2004377390","trial_id_7630353616","trial_id_9189104193")
